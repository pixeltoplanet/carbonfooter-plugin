...
class RestApiHandler {
	...
	private function register_settings_routes(): void {
		...
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array( $this, 'handle_get_settings_request' ),
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'handle_save_settings_request' ),
				'permission_callback' => array( $this, 'check_manage_options_permission' ),
	...
	private function get_settings_endpoint_args(): array {
		return array(
			'background_color' => array(
				...
				'validate_callback' => array( $this, 'validate_hex_color' ),
			...
			'display_setting'  => array(
				...
				'validate_callback' => array( $this, 'validate_display_setting' ),
				'description'       => __( 'Widget display setting (auto, manual, disabled)', 'carbonfooter' ),
			),
			'widget_style'     => array(
				'required'          => false,
				'sanitize_callback' => 'sanitize_text_field',
				'validate_callback' => array( $this, 'validate_widget_style' ),
	...
	public function handle_get_settings_request( \WP_REST_Request $request ) {
		try {
			...
			Logger::log(
				'Settings retrieved via REST API',
				array(
	...
	public function validate_display_setting( $value, \WP_REST_Request $request, string $param ) {
		...
		$valid_settings = array( 'auto', 'shortcode' );
