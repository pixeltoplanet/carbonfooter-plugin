...
const OverviewPageSize = ({ averagePageSize }) => {
	return (
		<div className="cf-icon-card">
			<div className="cf-icon-card__icon-container">
				...
				>
					<title>{__("Average page size", "carbonfooter")}</title>
			...
			<h2 className="cf-icon-card__title">{averagePageSize}</h2>
			<p className="cf-icon-card__text">
				{__("Average page size", "carbonfooter")}
			</p>
		</div>
	);
};

export default OverviewPageSize;
