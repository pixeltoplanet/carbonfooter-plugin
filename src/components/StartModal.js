					...
					{isLoading ? (
						...
						<Text>
							{emissions && emissions > 0
								? sprintf(
										/* translators: %s: formatted emissions amount (e.g., "1.23 g") */
										__("Per visit it will emit %s of CO2.", "carbonfooter"),
					...
					<div className="carbonfooter-modal-buttons">
						...
						>
							<svg
								...
								viewBox="0 0 256 256"
							>
								<title>{__("Back to settings", "carbonfooter")}</title>
						...
						>
							<svg
								...
								viewBox="0 0 256 256"
							>
								<title>{__("Arrow right", "carbonfooter")}</title>
